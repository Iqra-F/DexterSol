  ...
  return (
    <>
      <section
        ref={heroRef}
        id="home"
        className="relative bg-gradient-to-br from-[#040a13] to-[#043739] px-16 md:px-24 pb-4 mx-auto pt-64 items-center w-full overflow-hidden"
      >
        {/* Glowing stars */}
        ...
        <div className="relative z-10">
          <div
            className={`text-white flex flex-col py-10 gap-[35px] duration-1000 w-full`}
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-12">
              <button className="bg-[#F36434] flex gap-2 items-center rounded-lg font-bold text-base px-[13px] py-[16px]">
                CONTACT OUR EXPERTS <IoCaretForwardOutline />
              </button>
              <button className="font-bold text-lg p-[13px]">
                BOOK A MEETING
              </button>
            </div>
          </div>
          ...
          {/* Image */}
          <div className="absolute -right-20 md:-right-32 md:top-1  h-full w-1/2">
            <Image
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 z-20 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, i) => (
              ...
              >
                ...
                <div className="text-[#F06230] flex items-center text-[18px] font-medium">
                  Let&apos;s Co-Create{" "}
                  <span className="ml-2">
